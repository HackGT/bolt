...
async function createTable(tableName: string, callback: (builder: knex.CreateTableBuilder) => any): Promise<void> {
...
export async function createRecord<T extends object>(tableName: string, data: T): Promise<T> {
