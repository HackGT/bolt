        ...
        <Mutation mutation={UPDATE_USER}>
          {(submitForm: any, { loading, error, data }: any) => (
            ...
            >
              ...
              <Message>
                <Message.Content>
                  These details are provided by the{" "}
                  <a href="https://login.hack.gt">HackGT Login Service</a>.{" "}
                  {isAdmin ? (
                    "You may be able to change them there."
                  ) : (
                    <span>
                      Please <a href="mailto:hello@hack.gt">contact us</a> if any of these details
                      are inaccurate.
                    </span>
                  )}
                </Message.Content>
